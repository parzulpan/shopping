...
/* database: 订单数据库                                          */
/*==============================================================*/
drop database if exists shopping_oms;
create database shopping_oms character set utf8mb4 collate utf8mb4_general_ci;
...
/* database: 商品数据库                                          */
/*==============================================================*/
drop database if exists shopping_pms;
create database shopping_pms character set utf8mb4 collate utf8mb4_general_ci;
...
/* database: 优惠/营销数据库                                      */
/*==============================================================*/
drop database if exists shopping_sms;
create database shopping_sms character set utf8mb4 collate utf8mb4_general_ci;
...
/* database: 用户数据库                                          */
/*==============================================================*/
drop database if exists shopping_ums;
create database shopping_ums character set utf8mb4 collate utf8mb4_general_ci;
...
/* database: 仓储数据库                                          */
/*==============================================================*/
drop database if exists shopping_wms;
create database shopping_wms character set utf8mb4 collate utf8mb4_general_ci;
